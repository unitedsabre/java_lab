...
public class createXML {
    public static void main(String[] args) {
        try {
            ...
            title2.appendChild(doc.createTextNode("Мастер и Моргарита"));
            ...
            javax.xml.transform.stream.StreamResult result =
                    new javax.xml.transform.stream.StreamResult(new File("src/lr10/task1/XML/example.xml"));
